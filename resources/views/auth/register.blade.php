                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="documento_tipo" type="text" class="form-control @error('documento_tipo') is-invalid @enderror" name="documento_tipo" value="{{ old('documento_tipo') }}" required autocomplete="documento_tipo" autofocus>
