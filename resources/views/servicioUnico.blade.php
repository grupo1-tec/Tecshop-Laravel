            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle mb-2 text-muted">{{$servicio->created_at->toFormattedDateString()}}</h6>
                        <p class="card-text">{{$servicio->ser_descripcion}}</p>
                        <a href="{{action('ServiciosController@index')}}" class="card-link">
                            Todas las publicaciones
                        </a>
                    </div>
                </div>
                @auth
                    <form action="{{action('ComentarioController@store',['servicio_id' => $servicio->id])}}"
